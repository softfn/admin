...
// @Param	body		body 	ms.SysOrg	true		"body for SysOrg content"
// @Success 201 {int} ms.SysOrg
// @Failure 403 body is empty
// @router / [post]
func (c *SysOrgController) Post() {
	var v ms.SysOrg
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := ms.AddSysOrg(&v); err == nil {
...
// @Success 200 {object} ms.SysOrg
// @Failure 403 :id is empty
// @router /:id [get]
func (c *SysOrgController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := ms.GetSysOrgById(id)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = v
...
func (c *SysOrgController) GetAll() {
	...
	l, err := ms.GetAllSysOrg(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
func (c *SysOrgController) Put() {
	...
	v := ms.SysOrg{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := ms.UpdateSysOrgById(&v); err == nil {
			c.Data["json"] = "OK"
		} else {
			c.Data["json"] = err.Error()
		}
...
func (c *SysOrgController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := ms.DeleteSysOrg(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
